...
function calculateLWSVG(fastaFile) {
    ...
    calculatedHeight = secondSeq.length * 10;
    calculatedWidth = document.getElementById("vis").clientWidth;
...
function main(fastaFile, dataFile) {
    ...
    $("#structure").show();
    if (localFlag == true) {
        handleFirstPDB('glmol01');
        handleSecondPDB('glmol02');
    }
    else {
        view($("#firstseq").val(), 'glmol01');
        view($("#secondseq").val(), 'glmol02');
    }
